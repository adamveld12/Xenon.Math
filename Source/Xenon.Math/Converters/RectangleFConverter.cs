...
namespace Xenon.Math.Converters
{
    ...
    /// </summary>
    public class RectangleFConverter : BaseConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is RectangleF)
            {
                ...
                ConstructorInfo constructor = typeof(RectangleF).GetConstructor(new Type[]
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            return values != null ? new RectangleF(values[0], values[1], values[2], values[3]) : base.ConvertFrom(context, culture, value);
        }
