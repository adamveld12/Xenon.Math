...
namespace Xenon.Math
{
    ...
    /// </summary>
    public class MersennePrimeRandom : IRandom
    {
        private readonly uint[] _matrix = new uint[624];
        private int _index = 0;

        /// <summary>
        /// Initializes a new instance of <see cref="MersennePrimeRandom"/>
        /// </summary>
        public MersennePrimeRandom() : this((uint)DateTime.Now.Ticks) { }
        ...
        public int Next(int max)
        {
            ...
            return max == 0 ? 0 : randomValue % max;
        }
