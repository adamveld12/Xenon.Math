...
namespace Xenon.Math
{
    ...
    /// </summary>
    [TypeConverter(typeof(Xenon.Math.Converters.RectangleFConverter))]
    [Serializable]
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// Moves the <see cref="Rectangle"/>'s location by the specified amount
        /// </summary>
        /// <param name="amount">A <see cref="Vector2"/> that specifies how much to move</param>
